...
public class TinderSwipeActivity extends AppCompatActivity implements FlingCardListener.ActionDownInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAppAdapter = new MyAppAdapter(al, TinderSwipeActivity.this);
    ...
    public class MyAppAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(TinderSwipeActivity.this).load(parkingList.get(position).getImagePath()).into(viewHolder.cardImage);
